...
- **Trading Signals** — Crypto (BTC, SOL, ETH…) and Forex (EUR/USD, XAU/USD…) signals powered by the Ghost Wick Protocol (GWP), published via GitHub Actions bots every 30 minutes
...
| Bot | Markets | File |
|---|---|---|
| `ASTERIX_5PILLAR_BOT` | BTC, SOL, ETH, UNI, LINK, DEXE (4H chart) | `signal_bot.py` |
| `ASTERIX_PRECISION_BOT` | EUR/USD, GBP/USD, USD/JPY, XAU/USD (Kill Zone filtering) | `signal_bot.py` |
